...
namespace CitiesService.AsyncDataServices
{
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public MessageBusClient(IConfiguration configuration)
        {
            ...
            {
                System.Console.WriteLine($"--> Could not connect to RabbitMQ Bus: {ex.Message}");
            }
        }
        ...
        public void PublishNewCity(CityPublishedDto cityPublishedDto)
        {
            var message = JsonSerializer.Serialize(cityPublishedDto);
